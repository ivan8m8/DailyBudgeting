...
**2. This project has two branches:**
   ...
   * ``kotlin-mvvm-rx-aac-koin``. It's a current branch that is supported and is used to compile the DailyBudgeting app for the Google Play. The following stack is used: ``Kotlin``, ``MVVM``, ``RxJava 2``, ``Android Architecture Components``, ``Koin``. The SOLID principles are followed;
